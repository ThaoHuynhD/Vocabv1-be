...
CREATE TABLE `vocab_mean_table` (
    ...
    INDEX `vocab_mean_table_word_id_foreign`(`word_id`),
    PRIMARY KEY (`mean_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `vocab_mean_table` ADD CONSTRAINT `vocab_mean_table_word_id_foreign` FOREIGN KEY (`word_id`) REFERENCES `vocab_table`(`word_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
